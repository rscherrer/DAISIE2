## Let us now integrate the probabilities for a clade colonizing 20 Mya,
## splitting into two species 10 Mya and into three 5 Mya, all having made it
## to the present.
...
integrate_daisie(from = -30, to = -20, k = 0, nmax = 5, pars, init)
...
# Note: this is the result of the previous integration.
